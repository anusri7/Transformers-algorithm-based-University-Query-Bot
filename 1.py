...
questions = [
    ...
    #   "What is the CGPA of 20tuit002?",
    # "What is the overall percentage of 20tuit001?",
    #  "What is the GPA of 20tuit002 in the 5th semester?",
    ...
    #  "What is the training attendance percentage of 20tuit002?",
...
for name, info in data.items():
    ...
    target_text_training_attendance = f"{name}'s training attendance percentage is {info['training performance']}."
...
# Fine-tune the model
model.train()
for epoch in range(55):  # Adjust number of epochs as needed
    total_loss = 0
